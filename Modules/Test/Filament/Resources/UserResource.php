...
//                        ->mask(fn(Forms\Components\TextInput\Mask $mask)=>$mask->pattern('{0}00 000-0000')),
    ...
    {
        return [
            'index' => \Modules\Test\Filament\Resources\UserResource\Pages\ListUsers::route('/'),
            'create' => \Modules\Test\Filament\Resources\UserResource\Pages\CreateUser::route('/create'),
            'view' => \Modules\Test\Filament\Resources\UserResource\Pages\ViewUser::route('/{record}'),
            'edit' => \Modules\Test\Filament\Resources\UserResource\Pages\EditUser::route('/{record}/edit'),
        ];
    }
